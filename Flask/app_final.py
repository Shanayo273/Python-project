...
hotel2 = pd.read_csv(r'C:\Users\shana\Desktop\project\project\Final-Project-Hotel-Cancellation-Prediction\Flask\data\hotel_final.csv')
...
@app.route('/preview')
def preview():
    df = pd.read_csv(r'C:\Users\shana\Desktop\project\project\Final-Project-Hotel-Cancellation-Prediction\Flask\data\hotel_final.csv')
